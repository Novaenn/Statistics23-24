// The class that initializes the charts and their data
public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Attack attack = new Attack(100, 3000);
            ...
            objChart objChart2 = new objChart(systems, "optional_D");
            objHistogram objHist2 = new objHistogram(systems, "optional_D");
